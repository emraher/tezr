...
The vignette does not run live NTC queries during ordinary package builds. Set `TEZR_LIVE_EXAMPLES=true` before rendering if you want to execute the portal requests.
